<script>
  import { PUBLIC_ENTITY_DOMAIN, PUBLIC_ENTITY_NAME } from "$lib/constants";
</script>

<div class="gap-4 p-16 space-y-4 text-sm font-light text-black bg-white">
  <h1>PRIVACY POLICY</h1>
  <div>
    <p>
      At {PUBLIC_ENTITY_NAME}, accessible from {PUBLIC_ENTITY_DOMAIN}, one of
      our main priorities is the privacy of our visitors. This Privacy Policy
      document contains types of information that is collected and recorded by {PUBLIC_ENTITY_NAME}
      and how we use it.
    </p>
  </div>
  <div>
  ...
  <div>
    <p>
      ...
      and/or collect in {PUBLIC_ENTITY_NAME}. This policy is not applicable to
  ...
  <div>
    <h3>Log Files</h3>
    <p>
      {PUBLIC_ENTITY_NAME} follows a standard procedure of using log files. These
      ...
      identifiable. The purpose of the information is for analyzing trends, administering
      the site, tracking users’ movement on the website, and gathering demographic
      information. Our Privacy Policy was created with the help of the Privacy Policy
      Generator and the Online Privacy Policy Generator.
    </p>
  </div>
  <div>
    <h3>Cookies and Web Beacons</h3>
    <p>
      Like any other website, {PUBLIC_ENTITY_NAME} uses ‘cookies’. These cookies
      ...
      on visitors’ browser type and/or other information. For more general information
      on cookies, please read on https://www.cookieconsent.com/what-are-cookies/
    </p>
  </div>
  <div>
    <h3>Google DoubleClick DART</h3>
    <p>
      CookieGoogle is one of a third-party vendor on our site. It also uses
      ...
      visiting the Google ad and content network Privacy Policy at the following
  ...
  <div>
    ...
    <p>
      ...
      advertising partners of {PUBLIC_ENTITY_NAME}. Third-party ad servers or ad
      networks uses technologies like cookies, JavaScript, or Web Beacons that
      are used in their respective advertisements and links that appear on {PUBLIC_ENTITY_NAME},
      ...
      {PUBLIC_ENTITY_NAME} has no access to or control over these cookies that are
  ...
  <div>
    ...
    <p>
      {PUBLIC_ENTITY_NAME}’s Privacy Policy does not apply to other advertisers
  ...
  <div>
    ...
    <p>
      ...
      in, and/or monitor and guide their online activity. {PUBLIC_ENTITY_NAME} does
